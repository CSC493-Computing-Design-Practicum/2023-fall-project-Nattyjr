...
- Prerequisites
- Built With- HTML, CSS, Javascript, C#
- Author name- Nate
- Acknowledgments-
...
<code>concept.md</code>
  - Project Name- Negus tour and travel
  - Goals- Create a friendly tour and travel website using C# and ASP.NET 
  - Context- The Website will allow users to indicate their budget and it will guide them to explore the place(Ethiopia). places/stays/meals attraction.     
  - Novelty- I am working on this project inspired by friends who reached out to me when they had plans to visit Ethiopia/ it came to my mind to create a budget-friendly tourist can use. I will design this website from my experience and the research I will conduct.   
  - Functionality- responsive website
  - Audience- Tourists
  - Challenges- backend, working with which database will be the best for this project idea
  - Measures- useability and how usable it will be
  - Motivation- My country have a lot of places to visit and I want the world to know about my country
  - Future Extensions- Link the website with the Seabury Center website for users to get information about sign-up times, instructor hours, rooms available rooms, working times, and events happening.    
  - *Other (Optional)*
