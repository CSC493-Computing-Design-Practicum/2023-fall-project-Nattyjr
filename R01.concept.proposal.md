...
<code>concept.md</code>
  - Project Name- Hall of Fame
  - Goals- Create a friendly web app for fitness workers in C# and ASP.NET 
  - Context- The Website will allow users to sign in to their personal fitness account, showing them tasks/exercises to complete, give them reminders and notifications, sign up for other sports events/pick-ups, and show them exercise tutorials.     
  - Novelty- I am working on this project inspired by my gym workout sessions and the group I worked with this past summer in the YMCA center in Charlotte NC. I will design this website from my experience and the research I will conduct. Exercise videos will be recorded by local Berea students.  
  - Functionality- 
  - Audience
  - Challenges
  - Measures
